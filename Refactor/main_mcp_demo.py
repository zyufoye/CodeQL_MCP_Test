...
import time
import json
from check.project_analyze import analyze_project
from CodeQL.codeql_wapper import detect_language,call_codeql
...
def main():
    ...
    # 加载模型
    model, tokenizer = load_model_mcp()
